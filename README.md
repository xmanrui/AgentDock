...
- Built-in support for Codex and Claude Code providers
...
- Automatically discover local Codex and Claude Code sessions associated with the current project
...
| Built-in providers | Codex, Claude Code |
...
| Provider | Executable | Detection command | Start command | Resume command |
| --- | --- | --- | --- | --- |
